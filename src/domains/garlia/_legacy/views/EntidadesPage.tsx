...
import { FormularioMagico } from "@/domains/garlia/_legacy/components/magia/FormularioMagico";
import { CONFIG, type EntidadMagica } from "@/domains/garlia/_legacy/components/magia/types";
import { useCanciones } from "@/domains/garlia/canciones/useCanciones";
import type { Cancion } from "@/domains/garlia/canciones/types";
import { useGruposCriaturas } from "@/domains/garlia/_legacy/hooks/grupos/useGruposCriaturas";
import { useNotas } from "@/domains/garlia/_legacy/hooks/notas/useNotas";
import { type Nota } from "@/domains/garlia/_legacy/hooks/types";
import { useEntidadesMagicas } from "@/domains/garlia/_legacy/hooks/misc/useEntidadesMagicas";
import { EditorGrupo, GRUPO_TIPO_CONFIG, useGrupos, type GrupoTipo } from "@/domains/garlia/_legacy/views/EditorGrupo";
