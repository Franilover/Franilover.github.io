 ...
 * Personaje/Criatura. Reemplaza el sistema anterior de click del medio +
 * FullscreenEntityPanel (pantalla completa) y los estados locales
 * personajeAbierto/criaturaAbierta duplicados en GeografiaJerarquica y
 * CriaturasJerarquica.
 *
...
export type PanelFlotanteKind = "personaje" | "criatura";
